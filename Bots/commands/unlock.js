...
module.exports = {
    ...
    run: async(client, message, args) => {
        if(!message.member.hasPermission("UNLOCK_CHANNELS")) return message.reply("You do not have permissions to use this command!")
        ...
        .setDescription(`This channel has been unlocked by <@${message.author.id}>`)
        .setTimestamp()
